...
export const submitContactInquiry = async (req, res) => {
 ...
 // Remove spaces, +91, 91, or leading 0
...
// Check 10-digit Indian number starting with 6–9
const phoneRegex = /^[6-9]\d{9}$/;

if (!phoneRegex.test(normalizedPhone)) {
  return res
    .status(400)
    .json({ message: "Invalid phone number. Enter a valid 10-digit Indian mobile number." });
}

// Final phone number saved/sent in +91 format
